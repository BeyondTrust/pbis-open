    ...
    )
{
    ...
    LWIO_LOG_TRACE("Entering RdrWrite2\n");
...
cleanup:
    ...
    LWIO_LOG_TRACE("Exiting RdrWrite2\n");
    ...
    )
{
    ...
    LWIO_LOG_TRACE("Entering RdrFinishWriteChunk2\n");
...
cleanup:
    ...
    LWIO_LOG_TRACE("Exiting RdrFinishWriteChunk2\n");
