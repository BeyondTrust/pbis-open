    ...
    )
{
    ...
    pContext->SecReq.hContext = *phContext;
    pContext->Handle = *phContext;
    ...
    )
{
    ...
    pContext->CredsReq.hCredential = *phCredential;
    pContext->Handle = *phCredential;
    pContext->In.tag = NTLM_Q_FREE_CREDS;
    pContext->In.data = &pContext->CredsReq;
    pContext->Out.tag = LWMSG_TAG_INVALID;
    pContext->Out.data = NULL;
