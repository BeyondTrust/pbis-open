    ...
    )
{
    ...
    *pdwCount = 0;
    ...
    DCERPC_CALL(ntStatus, cli_LsaLookupNames(
                              (handle_t)hBinding,
                              hPolicy,
                              dwNumNames,
                              pLsaNames,
    ...
    if (SidArray.count > 0)
    {
        ...
        ntStatus = LsaAllocateTranslatedSids(pTransSids,
                                             &dwOffset,
                                             &dwSpaceLeft,
                                             &SidArray,
                                             &dwSize);
...
cleanup:
    ...
    LsaCleanStubTranslatedSidArray(&SidArray);
