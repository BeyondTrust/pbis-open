...
process_preauth(krb5_context context,
                ...
                krb5_pa_data ***pa_data_out)
{
    ...
    // The krb5_pa_data *pa_data_out value we set will have all elements
...
struct krb5_clpreauth_vtable_st preauthentication_client_1= 
{
    "PAC Request",           /* name */
