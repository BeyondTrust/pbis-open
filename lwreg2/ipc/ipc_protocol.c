...
static LWMsgTypeSpec gRegValueRangeInteger[] =
{
        ...
        LWMSG_MEMBER_INT32(LWREG_RANGE_INTEGER, Min),
        LWMSG_MEMBER_INT32(LWREG_RANGE_INTEGER, Max),
...
static LWMsgTypeSpec gRegValueAttributesSpec[] =
{
    ...
    LWMSG_MEMBER_UINT32(LWREG_VALUE_ATTRIBUTES, CurrentValueLen),
    LWMSG_MEMBER_PBYTE(LWREG_VALUE_ATTRIBUTES, pCurrentValue),
    LWMSG_ATTR_LENGTH_MEMBER(LWREG_VALUE_ATTRIBUTES, CurrentValueLen),
...
static LWMsgTypeSpec gRegGetOrDeleteValueAttrsSpec[] =
{
    // HKEY hKey
    // PCWSTR pSubKey
    // PCWSTR pValueName

    LWMSG_STRUCT_BEGIN(REG_IPC_GET_OR_DELETE_VALUE_ATTRS_REQ),

    LWMSG_MEMBER_HANDLE(REG_IPC_GET_OR_DELETE_VALUE_ATTRS_REQ, hKey, HKEY),
    LWMSG_ATTR_HANDLE_LOCAL_FOR_RECEIVER,

    LWMSG_MEMBER_PWSTR(REG_IPC_GET_OR_DELETE_VALUE_ATTRS_REQ, pSubKey),
    LWMSG_MEMBER_PWSTR(REG_IPC_GET_OR_DELETE_VALUE_ATTRS_REQ, pValueName),
