...
static LWMsgTypeSpec gServiceInfoSpec[] =
{
    ...
    LWMSG_ATTR_RANGE(LW_SERVICE_TYPE_LEGACY_EXECUTABLE, LW_SERVICE_TYPE_STUB),
...
static LWMsgTypeSpec gSetLogInfoSpec[] =
{
    ...
    LWMSG_MEMBER_UINT8(SM_SET_LOG_INFO_REQ, type),
...
static LWMsgTypeSpec gSetLogLevelSpec[] =
{
    ...
    LWMSG_MEMBER_UINT8(SM_SET_LOG_LEVEL_REQ, Level),
...
static LWMsgTypeSpec gGetLogStateResSpec[] =
{
    ...
    LWMSG_MEMBER_UINT8(SM_GET_LOG_STATE_RES, type),
    LWMSG_ATTR_RANGE(LW_SM_LOGGER_NONE, LW_SM_LOGGER_SYSLOG),
    LWMSG_MEMBER_PSTR(SM_GET_LOG_STATE_RES, pszTarget),
    LWMSG_MEMBER_UINT8(SM_GET_LOG_STATE_RES, Level),
    LWMSG_ATTR_RANGE(LW_SM_LOG_LEVEL_ALWAYS, LW_SM_LOG_LEVEL_TRACE),
    LWMSG_STRUCT_END,
    LWMSG_TYPE_END
};
...
static LWMsgTypeSpec gGlobalBooleanSpec[] =
{
...
static LWMsgTypeSpec gGlobalUnionSpec[] =
{
    ...
    LWMSG_MEMBER_TYPESPEC(SM_GLOBAL_UNION, Boolean, gGlobalBooleanSpec),
