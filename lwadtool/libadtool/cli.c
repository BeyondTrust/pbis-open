...
DWORD MakeFullArgsTable(IN AppContextTP appContext, IN struct poptOption *acts) {
     ...
     */
    i = 0;
    struct poptOption **newCellAction = MakeOptions(4);
    ADT_BAIL_ON_ALLOC_FAILURE(newCellAction);
    MakeOption(&((*newCellAction)[i++]),
               "dn",
               '\0',
               POPT_ARG_STRING,
               &(appContext->action.newCell.dn),
               0,
               "DN/RDN of the Organizational Unit to create the cell in or DN of the root naming context to create a default cell. (use \'-\' for stdin input) [X]",
               NULL);
    MakeOption(&((*newCellAction)[i++]),
               "home-dir-template",
               '\0',
               POPT_ARG_STRING,
               &(appContext->action.newCell.homeDirTemplate),
               0,
               "Template for user\'s home directory. Default: %H/%D/%U",
               NULL);
    MakeOption(&((*newCellAction)[i++]),
               "default-login-shell",
               '\0',
               POPT_ARG_STRING,
               &(appContext->action.newCell.defaultShell),
               0,
               "Users\'s login shell. Default: /bin/bash",
               NULL);
    MakeOption(ADT_TABLEEND(&((*newCellAction)[i++])));

    /**
     * Action.
     */
    i = 0;
    struct poptOption **editCellAction = MakeOptions(4);
    ADT_BAIL_ON_ALLOC_FAILURE(editCellAction);
    MakeOption(&((*editCellAction)[i++]),
               "dn",
               '\0',
               POPT_ARG_STRING,
               &(appContext->action.editCell.dn),
               0,
               "DN/RDN of the Organizational Unit containing the cell or DN of the root naming context to edit the default cell. (use \'-\' for stdin input) [X]",
               NULL);
    MakeOption(&((*editCellAction)[i++]),
               "home-dir-template",
               '\0',
               POPT_ARG_STRING,
               &(appContext->action.editCell.homeDirTemplate),
               0,
               "Template for users\' home directory. Default: %H/%D/%U",
               NULL);
    MakeOption(&((*editCellAction)[i++]),
               "default-login-shell",
               '\0',
               POPT_ARG_STRING,
               &(appContext->action.editCell.defaultShell),
               0,
               "Users\' default login shell. Default: /bin/bash",
               NULL);
    MakeOption(ADT_TABLEEND(&((*editCellAction)[i++])));

    /**
     * Action.
     */
    i = 0;
    struct poptOption **editCellUserAction = MakeOptions(9);
    ADT_BAIL_ON_ALLOC_FAILURE(editCellUserAction);
    MakeOption(&((*editCellUserAction)[i++]),
               "dn",
               '\0',
               POPT_ARG_STRING,
               &(appContext->action.editCellUser.dn),
               0,
               "DN/RDN of the Organizational Unit containing the cell or DN of the root naming context to edit user in the default cell. (use \'-\' for stdin input) [X]",
               NULL);
    MakeOption(&((*editCellUserAction)[i++]),
               "user",
               '\0',
               POPT_ARG_STRING,
               &(appContext->action.editCellUser.user),
               0,
               "User to change cell properties of. (DN/RDN, UPN, or SamAccountName; use \'-\' for stdin input). [X]",
               NULL);
    MakeOption(&((*editCellUserAction)[i++]),
               "uid",
               '\0',
               POPT_ARG_STRING,
               &(appContext->action.editCellUser.uid),
               0,
               "User ID",
               NULL);
    MakeOption(&((*editCellUserAction)[i++]),
               ...
               '\0',
               POPT_ARG_STRING,
               &(appContext->action.editCellUser.gid),
               0,
               "Primary group ID",
               NULL);
    MakeOption(&((*editCellUserAction)[i++]),
               ...
               '\0',
               POPT_ARG_STRING,
               &(appContext->action.editCellUser.loginName),
               0,
               "User\'s login name",
               NULL);
    MakeOption(&((*editCellUserAction)[i++]),
               ...
               '\0',
               POPT_ARG_STRING,
               &(appContext->action.editCellUser.homeDir),
               0,
    ...
    MakeOption(&((*editCellUserAction)[i++]),
               ...
               '\0',
               POPT_ARG_STRING,
               &(appContext->action.editCellUser.loginShell),
               0,
               "User\'s login shell",
               NULL);
    MakeOption(&((*editCellUserAction)[i++]),
               ...
               '\0',
               POPT_ARG_STRING,
               &(appContext->action.editCellUser.desc),
               0,
               "Description of the user",
               NULL);
    MakeOption(ADT_TABLEEND(&((*editCellUserAction)[i++])));

    /**
     * Action.
     */
    i = 0;
    struct poptOption **editCellGroupAction = MakeOptions(6);
    ADT_BAIL_ON_ALLOC_FAILURE(editCellGroupAction);
    MakeOption(&((*editCellGroupAction)[i++]),
               "dn",
               '\0',
               POPT_ARG_STRING,
               &(appContext->action.editCellGroup.dn),
               0,
               "DN/RDN of the Organizational Unit containing the cell or DN of the root naming context to edit group in the default cell. (use \'-\' for stdin input) [X]",
               NULL);
    MakeOption(&((*editCellGroupAction)[i++]),
               "group",
               '\0',
               POPT_ARG_STRING,
               &(appContext->action.editCellGroup.group),
               0,
               "Group to change cell properties of. (DN/RDN, or CN; use \'-\' for stdin input). [X]",
               NULL);
    MakeOption(&((*editCellGroupAction)[i++]),
               "gid",
               '\0',
               POPT_ARG_STRING,
               &(appContext->action.editCellGroup.gid),
               0,
               "Group ID",
               NULL);
    MakeOption(&((*editCellGroupAction)[i++]),
               ...
               '\0',
               POPT_ARG_STRING,
               &(appContext->action.editCellGroup.alias),
               0,
               "Group alias",
               NULL);
    MakeOption(&((*editCellGroupAction)[i++]),
               ...
               '\0',
               POPT_ARG_STRING,
               &(appContext->action.editCellGroup.desc),
               0,
               "Description of the group",
               NULL);
    MakeOption(ADT_TABLEEND(&((*editCellGroupAction)[i++])));

    /**
     * Action.
     */
    i = 0;
    struct poptOption **addToCellAction = MakeOptions(4);
    ADT_BAIL_ON_ALLOC_FAILURE(addToCellAction);
    MakeOption(&((*addToCellAction)[i++]),
               "dn",
               '\0',
               POPT_ARG_STRING,
               &(appContext->action.addToCell.dn),
               0,
               "OU containing the cell or DN of the root naming context to modify the default cell. (DN/RDN; use \'-\' for stdin input) [X]",
               NULL);
    MakeOption(&((*addToCellAction)[i++]),
               "user",
               '\0',
               POPT_ARG_STRING,
               &(appContext->action.addToCell.user),
               0,
               "User to add to the cell (DN/RDN, UPN, or SamAccountName; use \'-\' for stdin input).",
               NULL);
    MakeOption(&((*addToCellAction)[i++]),
               "group",
               '\0',
               POPT_ARG_STRING,
               &(appContext->action.addToCell.group),
               0,
               "Group to add to the cell (DN/RDN, or CN; use \'-\' for stdin input).",
               NULL);
    MakeOption(ADT_TABLEEND(&((*addToCellAction)[i++])));

    /**
     * Action.
     */
    i = 0;
    struct poptOption **removeFromCellAction = MakeOptions(5);
    ADT_BAIL_ON_ALLOC_FAILURE(removeFromCellAction);
    MakeOption(&((*removeFromCellAction)[i++]),
               "dn",
               '\0',
               POPT_ARG_STRING,
               &(appContext->action.removeFromCell.dn),
               0,
               "OU containing the cell or DN of the root naming context to modify the default cell. (DN/RDN; use \'-\' for stdin input) [X]",
               NULL);
    MakeOption(&((*removeFromCellAction)[i++]),
               ...
               '\0',
               POPT_ARG_STRING,
               &(appContext->action.removeFromCell.user),
               0,
               "User to remove from the cell (DN/RDN, UPN, or SamAccountName; use \'-\' for stdin input).",
               NULL);
    MakeOption(&((*removeFromCellAction)[i++]),
               "group",
               '\0',
               POPT_ARG_STRING,
               &(appContext->action.removeFromCell.group),
               0,
               "Group to remove from the cell (DN/RDN, or CN; use \'-\' for stdin input).",
               NULL);
    MakeOption(&((*removeFromCellAction)[i++]),
               "force",
               '\0',
               POPT_ARG_NONE,
               &(appContext->action.removeFromCell.isUnsetAttrs),
               0,
               "Unset values of uidNumber, gidNumber, loginShell, and unixHomeDirectory attributes when operating on a default LW cell",
               NULL);
    MakeOption(ADT_TABLEEND(&((*removeFromCellAction)[i++])));

    /**
     * Action.
     */
    i = 0;
    struct poptOption **linkCellAction = MakeOptions(3);
    ADT_BAIL_ON_ALLOC_FAILURE(linkCellAction);
    MakeOption(&((*linkCellAction)[i++]),
               "source-dn",
               '\0',
               POPT_ARG_STRING,
               &(appContext->action.linkCell.sourceCell),
               0,
               "OU of the cell to which a new link is to be added. (DN/RDN; use \'-\' for stdin input). [X]",
               NULL);
    MakeOption(&((*linkCellAction)[i++]),
               "target-dn",
               '\0',
               POPT_ARG_STRING,
               &(appContext->action.linkCell.targetCell),
               0,
               "OU containing the cell to link to (DN/RDN; use \'-\' for stdin input). [X]",
               NULL);
    MakeOption(ADT_TABLEEND(&((*linkCellAction)[i++])));

    /**
     * Action.
     */
    i = 0;
    struct poptOption **unlinkCellAction = MakeOptions(3);
    ADT_BAIL_ON_ALLOC_FAILURE(unlinkCellAction);
    MakeOption(&((*unlinkCellAction)[i++]),
               "source-dn",
               '\0',
               POPT_ARG_STRING,
               &(appContext->action.unlinkCell.sourceCell),
               0,
               "OU of the cell from which the link is to be removed (DN/RDN; use \'-\' for stdin input). [X]",
               NULL);
    MakeOption(&((*unlinkCellAction)[i++]),
               "target-dn",
               '\0',
               POPT_ARG_STRING,
               &(appContext->action.unlinkCell.targetCell),
               0,
               "OU containing the cell to unlink from (DN/RDN; use \'-\' for stdin input). [X]",
               NULL);
    MakeOption(ADT_TABLEEND(&((*unlinkCellAction)[i++])));

    /**
     * Action.
     */
    i = 0;
    struct poptOption **searchCellsAction = MakeOptions(5);
    ADT_BAIL_ON_ALLOC_FAILURE(searchCellsAction);
    MakeOption(&((*searchCellsAction)[i++]),
               "search-base",
               '\0',
               POPT_ARG_STRING,
               &(appContext->action.searchCells.base),
               0,
    ...
    MakeOption(&((*searchCellsAction)[i++]),
               ...
               '\0',
               POPT_ARG_STRING,
               &(appContext->action.searchCells.scope),
               0,
    ...
    MakeOption(&((*searchCellsAction)[i++]),
               ...
               '\0',
               POPT_ARG_STRING,
               &(appContext->action.searchCells.user),
               0,
               "Search for cells the user is a member of (DN/RDN, UPN, or SamAccountName; use \'-\' for stdin input).",
               NULL);
    MakeOption(&((*searchCellsAction)[i++]),
               "group",
               '\0',
               POPT_ARG_STRING,
               &(appContext->action.searchCells.group),
               0,
               "Search for cells the group is a member of (DN/RDN, or CN; use \'-\' for stdin input).",
               NULL);
    MakeOption(ADT_TABLEEND(&((*searchCellsAction)[i++])));

    /**
     * Action.
     */
    i = 0;
    struct poptOption **lookupCellAction = MakeOptions(8);
    ADT_BAIL_ON_ALLOC_FAILURE(lookupCellAction);
    MakeOption(&((*lookupCellAction)[i++]),
               "dn",
               '\0',
               POPT_ARG_STRING,
               &(appContext->action.lookupCell.dn),
               0,
               "DN/RDN of the Organizational Unit containing the cell or DN of the root naming context to look up the default cell. (use \'-\' for stdin input) [X]",
               NULL);
    MakeOption(&((*lookupCellAction)[i++]),
               "home-dir-template",
               '\0',
               POPT_ARG_NONE,
               &(appContext->action.lookupCell.isHomeDirTemplate),
               0,
               "Show template of users\' home directory.",
               NULL);
    MakeOption(&((*lookupCellAction)[i++]),
               "default-login-shell",
               '\0',
               POPT_ARG_NONE,
               &(appContext->action.lookupCell.isDefaultShell),
               0,
               "Show users\' default login shell.",
               NULL);
    MakeOption(&((*lookupCellAction)[i++]),
               "users",
               '\0',
               POPT_ARG_NONE,
               &(appContext->action.lookupCell.isUsers),
               0,
               "Show users defined in the cell.",
               NULL);
    MakeOption(&((*lookupCellAction)[i++]),
               "groups",
               '\0',
               POPT_ARG_NONE,
               &(appContext->action.lookupCell.isGroups),
               0,
               "Show groups defined in the cell.",
               NULL);
    MakeOption(&((*lookupCellAction)[i++]),
               "linked-cells",
               '\0',
               POPT_ARG_NONE,
               &(appContext->action.lookupCell.isLinkedCells),
               0,
               "Show linked cells",
               NULL);
    MakeOption(&((*lookupCellAction)[i++]),
               ...
               '\0',
               POPT_ARG_NONE,
               &(appContext->action.lookupCell.isAll),
               0,
               "Show all cell properties",
               NULL);
    MakeOption(ADT_TABLEEND(&((*lookupCellAction)[i++])));

    /**
     * Action.
     */
    i = 0;
    struct poptOption **lookupCellUserAction = MakeOptions(10);
    ADT_BAIL_ON_ALLOC_FAILURE(lookupCellUserAction);
    MakeOption(&((*lookupCellUserAction)[i++]),
               "dn",
               '\0',
               POPT_ARG_STRING,
               &(appContext->action.lookupCellUser.dn),
               0,
               "DN/RDN of the Organizational Unit containing the cell or DN of the root naming context to use the default cell. (use \'-\' for stdin input) [X]",
               NULL);
    MakeOption(&((*lookupCellUserAction)[i++]),
               "user",
               '\0',
               POPT_ARG_STRING,
               &(appContext->action.lookupCellUser.user),
               0,
               "User to look up cell properties of. (DN/RDN, UPN, or SamAccountName; use \'-\' for stdin input) [X]",
               NULL);
    MakeOption(&((*lookupCellUserAction)[i++]),
               "uid",
               '\0',
               POPT_ARG_NONE,
               &(appContext->action.lookupCellUser.isUid),
               0,
               "Show user ID.",
               NULL);
    MakeOption(&((*lookupCellUserAction)[i++]),
               ...
               '\0',
               POPT_ARG_NONE,
               &(appContext->action.lookupCellUser.isGid),
               0,
    ...
    MakeOption(&((*lookupCellUserAction)[i++]),
               ...
               '\0',
               POPT_ARG_NONE,
               &(appContext->action.lookupCellUser.isLoginName),
               0,
               "Show login name.",
               NULL);
    MakeOption(&((*lookupCellUserAction)[i++]),
               ...
               '\0',
               POPT_ARG_NONE,
               &(appContext->action.lookupCellUser.isHomeDir),
               0,
               "Show home directory.",
               NULL);
    MakeOption(&((*lookupCellUserAction)[i++]),
               ...
               '\0',
               POPT_ARG_NONE,
               &(appContext->action.lookupCellUser.isLoginShell),
               0,
               "Show login shell.",
               NULL);
    MakeOption(&((*lookupCellUserAction)[i++]),
               ...
               '\0',
               POPT_ARG_NONE,
               &(appContext->action.lookupCellUser.isComment),
               0,
               "Show description.",
               NULL);
    MakeOption(&((*lookupCellUserAction)[i++]),
               ...
               '\0',
               POPT_ARG_NONE,
               &(appContext->action.lookupCellUser.isAll),
               0,
               "Show all properties of the user.",
               NULL);
    MakeOption(ADT_TABLEEND(&((*lookupCellUserAction)[i++])));

    /**
     * Action.
     */
    i = 0;
    struct poptOption **lookupCellGroupAction = MakeOptions(7);
    ADT_BAIL_ON_ALLOC_FAILURE(lookupCellGroupAction);
    MakeOption(&((*lookupCellGroupAction)[i++]),
               "dn",
               '\0',
               POPT_ARG_STRING,
               &(appContext->action.lookupCellGroup.dn),
               0,
               "DN/RDN of the Organizational Unit containing the cell or DN of the root naming context to use the default cell. (use \'-\' for stdin input) [X]",
               NULL);
    MakeOption(&((*lookupCellGroupAction)[i++]),
               ...
               '\0',
               POPT_ARG_STRING,
               &(appContext->action.lookupCellGroup.group),
               0,
               "Group to look up cell properties of. (DN/RDN, or CN; use \'-\' for stdin input) [X]",
               NULL);
    MakeOption(&((*lookupCellGroupAction)[i++]),
               "gid",
               '\0',
               POPT_ARG_NONE,
               &(appContext->action.lookupCellGroup.isGid),
               0,
               "Show group ID",
               NULL);
    MakeOption(&((*lookupCellGroupAction)[i++]),
               ...
               '\0',
               POPT_ARG_NONE,
               &(appContext->action.lookupCellGroup.isAlias),
               0,
               "Show group alias",
               NULL);
    MakeOption(&((*lookupCellGroupAction)[i++]),
               ...
               '\0',
               POPT_ARG_NONE,
               &(appContext->action.lookupCellGroup.isDesc),
               0,
               "Show description of the group",
               NULL);
    MakeOption(&((*lookupCellGroupAction)[i++]),
               "all",
               '\0',
               POPT_ARG_NONE,
               &(appContext->action.lookupCellGroup.isAll),
               0,
               "Show all properties of the group.",
               NULL);
    MakeOption(ADT_TABLEEND(&((*lookupCellGroupAction)[i++])));

    /**
     * Action.
     */
    i = 0;
    struct poptOption **deleteCellAction = MakeOptions(3);
    ADT_BAIL_ON_ALLOC_FAILURE(deleteCellAction);
    MakeOption(&((*deleteCellAction)[i++]),
               "dn",
               '\0',
               POPT_ARG_STRING,
               &(appContext->action.deleteCell.dn),
               0,
               "DN/RDN of the cell or OU containing the cell or DN of the root naming context to delete the default cell. (use \'-\' for stdin input) [X]",
               NULL);
    MakeOption(&((*deleteCellAction)[i++]),
               "force",
               '\0',
               POPT_ARG_NONE,
               &(appContext->action.deleteCell.isDeleteMembers),
               0,
               "remove users/groups/maps from the cell first. Default: fail if cell is not empty",
               NULL);
    MakeOption(ADT_TABLEEND(&((*deleteCellAction)[i++])));

    /**
     * Action.
     */
    i = 0;
    struct poptOption **entActionsTable = MakeOptions(14);
    ADT_BAIL_ON_ALLOC_FAILURE(entActionsTable);
    MakeOption(&((*entActionsTable)[i++]),
               NULL,
               'E',
               POPT_ARG_INCLUDE_TABLE,
               *addToCellAction,
               AdtAddToCellAction,
               ADT_ADD_TO_CELL_ACT " - add user/group to a Likewise cell.",
               NULL);
    MakeOption(&((*entActionsTable)[i++]),
               NULL,
               'E',
               ...
               *deleteCellAction,
               AdtDeleteCellAction,
               ADT_DELETE_CELL_ACT " - delete a Likewise cell.",
               NULL);
    MakeOption(&((*entActionsTable)[i++]),
               NULL,
               'E',
               ...
               *editCellAction,
               AdtEditCellAction,
               ADT_EDIT_CELL_ACT " - modify Likewise cell properties.",
               NULL);
    MakeOption(&((*entActionsTable)[i++]),
               NULL,
               'E',
               ...
               *editCellGroupAction,
               ...
               ADT_EDIT_CELL_GROUP_ACT " - modify properties of a cell\'s group.",
               NULL);
    MakeOption(&((*entActionsTable)[i++]),
               NULL,
               'E',
               ...
               *editCellUserAction,
               ...
               ADT_EDIT_CELL_USER_ACT " - modify properties of a cell\'s user.",
               NULL);
    MakeOption(&((*entActionsTable)[i++]),
               NULL,
               'E',
               ...
               *linkCellAction,
               AdtLinkCellAction,
               ADT_LINK_CELL_ACT " - link Likewise cells.",
               NULL);
    MakeOption(&((*entActionsTable)[i++]),
               NULL,
               'E',
               ...
               *lookupCellAction,
               AdtLookupCellAction,
               ADT_LOOKUP_CELL_ACT " - retrieve Likewise cell properties.",
               NULL);
    MakeOption(&((*entActionsTable)[i++]),
               NULL,
               'E',
               POPT_ARG_INCLUDE_TABLE,
               *lookupCellGroupAction,
               AdtLookupCellGroupAction,
               ADT_lOOKUP_CELL_GROUP_ACT " - retrieve properties of cell\'s group.",
               NULL);
    MakeOption(&((*entActionsTable)[i++]),
               NULL,
               'E',
               POPT_ARG_INCLUDE_TABLE,
               *lookupCellUserAction,
               AdtLookupCellUserAction,
               ADT_LOOKUP_CELL_USER_ACT " - retrieve properties of cell\'s user.",
               NULL);
    MakeOption(&((*entActionsTable)[i++]),
               NULL,
               'E',
               ...
               *newCellAction,
               AdtNewCellAction,
               ADT_NEW_CELL_ACT " - create a new Likewise cell.",
               NULL);
    MakeOption(&((*entActionsTable)[i++]),
               NULL,
               'E',
               ...
               *removeFromCellAction,
               ...
               ADT_REMOVE_FROM_CELL_ACT " - remove user/group from a Likewise cell.",
               NULL);
    MakeOption(&((*entActionsTable)[i++]),
               NULL,
               'E',
               ...
               *searchCellsAction,
               ...
               ADT_SEARCH_CELLS_ACT " - search for Likewise cells.",
               NULL);
    MakeOption(&((*entActionsTable)[i++]),
               NULL,
               'E',
               ...
               *unlinkCellAction,
               AdtUnlinkCellAction,
               ADT_UNLINK_CELL_ACT " - unlink Likewise cells.",
               NULL);
    MakeOption(ADT_TABLEEND(&((*entActionsTable)[i++])));
    ...
    */
    ...
    MakeOption(ADT_TABLEEND(&((*actionsTable)[i++])));
        ...
        LW_SAFE_FREE_MEMORY(newCellAction);
        LW_SAFE_FREE_MEMORY(editCellAction);
        LW_SAFE_FREE_MEMORY(editCellUserAction);
        LW_SAFE_FREE_MEMORY(editCellGroupAction);
        LW_SAFE_FREE_MEMORY(addToCellAction);
        LW_SAFE_FREE_MEMORY(removeFromCellAction);
        LW_SAFE_FREE_MEMORY(linkCellAction);
        LW_SAFE_FREE_MEMORY(unlinkCellAction);
        LW_SAFE_FREE_MEMORY(searchCellsAction);
        LW_SAFE_FREE_MEMORY(lookupCellAction);
        LW_SAFE_FREE_MEMORY(lookupCellUserAction);
        LW_SAFE_FREE_MEMORY(lookupCellGroupAction);
        LW_SAFE_FREE_MEMORY(deleteCellAction);
        LW_SAFE_FREE_MEMORY(entActionsTable);
