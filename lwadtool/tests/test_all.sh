...
# FULL COMMAND #
################
ADT_CMD="./lwo-adtool $ADT_CONN_SERVER $ADT_CONN_PORT $ADT_CONN_DOMAIN $ADT_SCHEMA $ADT_AUTH_NAME $ADT_AUTH_PASSWD $ADT_AUTH_SEC_MODE $ADT_AUTH_KEYTAB $ADT_AUTH_KRB5CC $ADT_OPT_QUIET $ADT_OPT_LOG_LEVEL -a"
