...
remove_extra_files()
{
    ...
    for file in /etc/pam.conf /etc/pam.d/* /etc/krb5.conf /etc/krb5/* /etc/hosts /etc/sshd_config /etc/ssh_config /etc/ssh/* /opt/ssh/etc/sshd_config /opt/ssh/etc/ssh_config /etc/nsswitch.conf /etc/skel /etc/inet /etc/inet/* /etc/apparmor.d/abstractions/* ; do
