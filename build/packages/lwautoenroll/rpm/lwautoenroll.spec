...
Summary:	Likewise Certificate AutoEnrollment API
Version: 	%{RpmVersion}
Release: 	%{RpmRelease}
...
%package devel
Summary: Likewise Certificate AutoEnrollment API Development Kit
Group: Development/Libraries
Requires: likewise-autoenroll

%description devel
The likewise-autoenroll-devel package includes the development libraries and header files that supply the application programming interface for the Likewise Certificate AutoEnrollment API.
...
%define initScriptPathList %{INIT_DIR}/lwcertd
%post
