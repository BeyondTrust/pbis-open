...
Requires: likewise-lwnetapi, likewise-sqlite
...
%description
The Likewise Task system contains components to schedule tasks such as share migration.

%package devel
Summary: Likewise Task System Software Development Kit
Group: Development/Libraries
Requires: likewise-lwtask

%description devel
The likewise-lwtask-devel package includes the development libraries and header files that supply the application programming interface for the Likewise Task System, which is used to create, schedule and repeat tasks such as share migration.
...
%if ! %{Compat32}
%define initScriptPathList %{INIT_DIR}/lwtaskd
%post
