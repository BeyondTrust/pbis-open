...
class UserMigrateApp : public TApplication
{
    public:
							
		UserMigrateApp();
        virtual ~UserMigrateApp();
		
	protected:
	    
		UserMigrateApp(const UserMigrateApp& other);
		UserMigrateApp& operator=(const UserMigrateApp& other);
