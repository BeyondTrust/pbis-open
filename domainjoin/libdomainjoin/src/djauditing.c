    ...
    )
{
    ...
    if(enable)
    {
        DJ_LOG_INFO("Configuring BeyondTrust AD Bridge to run eventfwdd daemon");
    ...
    {
        DJ_LOG_INFO("Deconfiguring BeyondTrust AD Bridge from running eventfwdd daemon");
    ...
    )
{
    ...
    if(enable)
    {
        DJ_LOG_INFO("Configuring BeyondTrust AD Bridge to run reapsysld daemon");
    ...
    {
        DJ_LOG_INFO("Deconfiguring BeyondTrust AD Bridge from running reapsysld daemon");
