...
BOOLEAN gbPollerThreadRunning = FALSE;
BOOLEAN gbPollerRefresh = FALSE;
pthread_t gPollerThread;
BOOLEAN gbPollerThreadShouldExit = FALSE;

pthread_cond_t gSignalPoller;
