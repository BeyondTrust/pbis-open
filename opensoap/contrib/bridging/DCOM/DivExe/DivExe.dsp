# Microsoft Developer Studio Project File - Name="DivExe" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** ï“èWÇµÇ»Ç¢Ç≈Ç≠ÇæÇ≥Ç¢ **

# TARGTYPE "Win32 (x86) Application" 0x0101

CFG=DivExe - Win32 Debug
...
!MESSAGE 
!MESSAGE NMAKE /f "DivExe.mak".
!MESSAGE 
!MESSAGE NMAKE ÇÃé¿çséûÇ…ç\ê¨ÇéwíËÇ≈Ç´Ç‹Ç∑
!MESSAGE ∫œ›ƒﬁ ◊≤›è„Ç≈œ∏€ÇÃê›íËÇíËã`ÇµÇ‹Ç∑ÅBó·:
!MESSAGE 
!MESSAGE NMAKE /f "DivExe.mak" CFG="DivExe - Win32 Debug"
!MESSAGE 
!MESSAGE ëIëâ¬î\Ç»ÀﬁŸƒﬁ ”∞ƒﬁ:
!MESSAGE 
!MESSAGE "DivExe - Win32 Debug" ("Win32 (x86) Application" óp)
!MESSAGE "DivExe - Win32 Unicode Debug" ("Win32 (x86) Application" óp)
!MESSAGE "DivExe - Win32 Release MinSize" ("Win32 (x86) Application" óp)
!MESSAGE "DivExe - Win32 Release MinDependency" ("Win32 (x86) Application" óp)
!MESSAGE "DivExe - Win32 Unicode Release MinSize" ("Win32 (x86) Application" óp)
!MESSAGE "DivExe - Win32 Unicode Release MinDependency" ("Win32 (x86) Application" óp)
!MESSAGE 
...
OutDir=.\Debug
TargetPath=.\Debug\DivExe.exe
InputPath=.\Debug\DivExe.exe
SOURCE="$(InputPath)"
...
!ELSEIF  "$(CFG)" == "DivExe - Win32 Unicode Debug"
...
# Begin Custom Build - ìoò^ÇçsÇ¡ÇƒÇ¢Ç‹Ç∑
OutDir=.\DebugU
TargetPath=.\DebugU\DivExe.exe
InputPath=.\DebugU\DivExe.exe
SOURCE="$(InputPath)"
...
!ELSEIF  "$(CFG)" == "DivExe - Win32 Release MinSize"
...
TargetPath=.\ReleaseMinSize\DivExe.exe
InputPath=.\ReleaseMinSize\DivExe.exe
SOURCE="$(InputPath)"
...
!ELSEIF  "$(CFG)" == "DivExe - Win32 Release MinDependency"
...
TargetPath=.\ReleaseMinDependency\DivExe.exe
InputPath=.\ReleaseMinDependency\DivExe.exe
SOURCE="$(InputPath)"
...
!ELSEIF  "$(CFG)" == "DivExe - Win32 Unicode Release MinSize"
...
TargetPath=.\ReleaseUMinSize\DivExe.exe
InputPath=.\ReleaseUMinSize\DivExe.exe
SOURCE="$(InputPath)"
...
!ELSEIF  "$(CFG)" == "DivExe - Win32 Unicode Release MinDependency"
...
TargetPath=.\ReleaseUMinDependency\DivExe.exe
InputPath=.\ReleaseUMinDependency\DivExe.exe
SOURCE="$(InputPath)"
...
# Name "DivExe - Win32 Debug"
# Name "DivExe - Win32 Unicode Debug"
# Name "DivExe - Win32 Release MinSize"
# Name "DivExe - Win32 Release MinDependency"
# Name "DivExe - Win32 Unicode Release MinSize"
# Name "DivExe - Win32 Unicode Release MinDependency"
...
SOURCE=.\DivExe.idl
# ADD MTL /tlb ".\DivExe.tlb" /h "DivExe.h" /iid "DivExe_i.c" /Oicf
# End Source File
# Begin Source File
