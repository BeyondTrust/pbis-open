// DivExe.cpp : WinMain のインプリメンテーション


// メモ: Proxy/Stub 情報
//  別々の proxy/stub DLL をビルドするためには、プロジェクトのディレクトリで 
//      nmake -f DivExeps.mak を実行してください。
...
OBJECT_ENTRY(CLSID_DivideExe, CDivideExe)
END_OBJECT_MAP()
    ...
    HINSTANCE /*hPrevInstance*/, LPTSTR lpCmdLine, int /*nShowCmd*/)
{
    ...
    _Module.Init(ObjectMap, hInstance, &LIBID_DIVEXELib);
    ...
    while (lpszToken != NULL)
    {
        ...
        {
            _Module.UpdateRegistryFromResource(IDR_DivExe, FALSE);
        ...
        {
            _Module.UpdateRegistryFromResource(IDR_DivExe, TRUE);
