// MultiExe.cpp : WinMain のインプリメンテーション


// メモ: Proxy/Stub 情報
//  別々の proxy/stub DLL をビルドするためには、プロジェクトのディレクトリで 
//      nmake -f MultiExeps.mak を実行してください。
...
OBJECT_ENTRY(CLSID_MultiplyExe, CMultiplyExe)
END_OBJECT_MAP()
    ...
    HINSTANCE /*hPrevInstance*/, LPTSTR lpCmdLine, int /*nShowCmd*/)
{
    ...
    _Module.Init(ObjectMap, hInstance, &LIBID_MULTIEXELib);
    ...
    while (lpszToken != NULL)
    {
        ...
        {
            _Module.UpdateRegistryFromResource(IDR_MultiExe, FALSE);
        ...
        {
            _Module.UpdateRegistryFromResource(IDR_MultiExe, TRUE);
