// AdExe.cpp : WinMain のインプリメンテーション


// メモ: Proxy/Stub 情報
//  別々の proxy/stub DLL をビルドするためには、プロジェクトのディレクトリで 
//      nmake -f AdExeps.mak を実行してください。
...
OBJECT_ENTRY(CLSID_AddExe, CAddExe)
END_OBJECT_MAP()
    ...
    HINSTANCE /*hPrevInstance*/, LPTSTR lpCmdLine, int /*nShowCmd*/)
{
    ...
    _Module.Init(ObjectMap, hInstance, &LIBID_ADEXELib);
    ...
    while (lpszToken != NULL)
    {
        ...
        {
            _Module.UpdateRegistryFromResource(IDR_AdExe, FALSE);
        ...
        {
            _Module.UpdateRegistryFromResource(IDR_AdExe, TRUE);
