# Microsoft Developer Studio Project File - Name="SubExe" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** ï“èWÇµÇ»Ç¢Ç≈Ç≠ÇæÇ≥Ç¢ **

# TARGTYPE "Win32 (x86) Application" 0x0101

CFG=SubExe - Win32 Debug
...
!MESSAGE 
!MESSAGE NMAKE /f "SubExe.mak".
!MESSAGE 
!MESSAGE NMAKE ÇÃé¿çséûÇ…ç\ê¨ÇéwíËÇ≈Ç´Ç‹Ç∑
!MESSAGE ∫œ›ƒﬁ ◊≤›è„Ç≈œ∏€ÇÃê›íËÇíËã`ÇµÇ‹Ç∑ÅBó·:
!MESSAGE 
!MESSAGE NMAKE /f "SubExe.mak" CFG="SubExe - Win32 Debug"
!MESSAGE 
!MESSAGE ëIëâ¬î\Ç»ÀﬁŸƒﬁ ”∞ƒﬁ:
!MESSAGE 
!MESSAGE "SubExe - Win32 Debug" ("Win32 (x86) Application" óp)
!MESSAGE "SubExe - Win32 Unicode Debug" ("Win32 (x86) Application" óp)
!MESSAGE "SubExe - Win32 Release MinSize" ("Win32 (x86) Application" óp)
!MESSAGE "SubExe - Win32 Release MinDependency" ("Win32 (x86) Application" óp)
!MESSAGE "SubExe - Win32 Unicode Release MinSize" ("Win32 (x86) Application" óp)
!MESSAGE "SubExe - Win32 Unicode Release MinDependency" ("Win32 (x86) Application" óp)
!MESSAGE 
...
OutDir=.\Debug
TargetPath=.\Debug\SubExe.exe
InputPath=.\Debug\SubExe.exe
SOURCE="$(InputPath)"
...
!ELSEIF  "$(CFG)" == "SubExe - Win32 Unicode Debug"
...
# Begin Custom Build - ìoò^ÇçsÇ¡ÇƒÇ¢Ç‹Ç∑
OutDir=.\DebugU
TargetPath=.\DebugU\SubExe.exe
InputPath=.\DebugU\SubExe.exe
SOURCE="$(InputPath)"
...
!ELSEIF  "$(CFG)" == "SubExe - Win32 Release MinSize"
...
TargetPath=.\ReleaseMinSize\SubExe.exe
InputPath=.\ReleaseMinSize\SubExe.exe
SOURCE="$(InputPath)"
...
!ELSEIF  "$(CFG)" == "SubExe - Win32 Release MinDependency"
...
TargetPath=.\ReleaseMinDependency\SubExe.exe
InputPath=.\ReleaseMinDependency\SubExe.exe
SOURCE="$(InputPath)"
...
!ELSEIF  "$(CFG)" == "SubExe - Win32 Unicode Release MinSize"
...
TargetPath=.\ReleaseUMinSize\SubExe.exe
InputPath=.\ReleaseUMinSize\SubExe.exe
SOURCE="$(InputPath)"
...
!ELSEIF  "$(CFG)" == "SubExe - Win32 Unicode Release MinDependency"
...
TargetPath=.\ReleaseUMinDependency\SubExe.exe
InputPath=.\ReleaseUMinDependency\SubExe.exe
SOURCE="$(InputPath)"
...
# Name "SubExe - Win32 Debug"
# Name "SubExe - Win32 Unicode Debug"
# Name "SubExe - Win32 Release MinSize"
# Name "SubExe - Win32 Release MinDependency"
# Name "SubExe - Win32 Unicode Release MinSize"
# Name "SubExe - Win32 Unicode Release MinDependency"
...
SOURCE=.\SubExe.idl
# ADD MTL /tlb ".\SubExe.tlb" /h "SubExe.h" /iid "SubExe_i.c" /Oicf
# End Source File
# Begin Source File
