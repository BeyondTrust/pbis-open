// AdDll.cpp : DLL エクスポートのインプリメンテーション


// メモ: Proxy/Stub 情報
//  別々の proxy/stub DLL をビルドするためには、プロジェクトのディレクトリで 
//      nmake -f AdDllps.mak を実行してください。
...
OBJECT_ENTRY(CLSID_AddDll, CAddDll)
END_OBJECT_MAP()
...
BOOL WINAPI DllMain(HINSTANCE hInstance, DWORD dwReason, LPVOID /*lpReserved*/)
{
    ...
    {
        _Module.Init(ObjectMap, hInstance, &LIBID_ADDLLLib);
...
STDAPI DllRegisterServer(void)
{
	...
	_Module.UpdateRegistryFromResourceD( IDR_ADD, TRUE );
...
{
	_Module.UpdateRegistryFromResourceD( IDR_ADD, FALSE );
