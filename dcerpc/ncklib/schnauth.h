...
PRIVATE rpc_protocol_id_t       rpc__schnauth_cn_init _DCE_PROTOTYPE_((
...
void rpc__schnauth_bnd_set_auth _DCE_PROTOTYPE_ ((
...
void rpc__schnauth_srv_reg_auth _DCE_PROTOTYPE_ ((
        unsigned_char_p_t                   /* in  */    /*server_princ_name*/,
...
void rpc__schnauth_mgt_inq_def _DCE_PROTOTYPE_ ((
        unsigned32                          /* out */   * /*authn_level*/,
        unsigned32                          /* out */   * /*st*/
    ));

void rpc__schnauth_inq_my_princ_name _DCE_PROTOTYPE_ ((
        unsigned32                          /* in */     /*princ_name_size*/,
        unsigned_char_p_t                   /* out */    /*princ_name*/,
        unsigned32                          /* out */   * /*st*/
    ));

void rpc__schnauth_free_info _DCE_PROTOTYPE_((                         
        rpc_auth_info_p_t                   /* in/out */ * /*info*/
    ));

void rpc__schnauth_free_key _DCE_PROTOTYPE_ ((
        rpc_key_info_p_t                    /* in/out */ * /*key_info*/
    ));

error_status_t rpc__schnauth_resolve_identity _DCE_PROTOTYPE_ ((
        rpc_auth_identity_handle_t          /* in */ /*in_identity*/,
        rpc_auth_identity_handle_t          /* out */ *out_identity
    ));

void rpc__schnauth_release_identity _DCE_PROTOTYPE_ ((
        rpc_auth_identity_handle_t          /* in/out */ * /*identity*/
    ));

void rpc__schnauth_inq_sec_context _DCE_PROTOTYPE_ ((
...
sec_id_pac_t *rpc__schnauth_get_pac _DCE_PROTOTYPE_((void));
