    ...
    )
{
    ...
    MAC_AD_LOG_INFO("Calling ADUCopyFileFromRemote(Src:%s, Dest:%s)", pszFQSrcPath, pszDestPath);
    ...
    )
{
    ...
    MAC_AD_LOG_INFO("Calling ADUSMBPutFile(Domain: %s, Src Path: %s, Dest Path: %s)", pszDomainName, pszFQSrcPath, pszFQDstPath);
    ...
    )
{
    ...
    MAC_AD_LOG_INFO("Calling ADUSMBGetFolder(Src:%s, Dest:%s)", pszFQSrcPath, pszDestFolder);
    ...
    )
{
    ...
    MAC_AD_LOG_INFO("Calling ADUSMBPutFolder(Src : %s, Dest:%s)", pszFQSrcPath, pszFQDstPath);
